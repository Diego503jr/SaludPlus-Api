...
exports.updateAsistido = async (id, asistidoCita, medicoId) => {
    ...
    try {
        ...
        console.error("=== ERROR EN asistencia.service (updateAsistido) ===");
        console.error("ID cita:", id);
        console.error("medicoId:", medicoId);
        console.error("body:", asistidoCita);
        console.error("Mensaje:", error.message);
        console.error("Stack:", error.stack);

        // Relanzamos para que el controller maneje el status (400/404)
        throw error;
    }
};