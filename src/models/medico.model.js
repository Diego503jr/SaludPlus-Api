    ...
    let result = await client.query(
      `SELECT U.id AS usuarioId, U.nombre, U.apellido, U.dui, U.email, U.telefono, U.fecha_nacimiento AS fechaNacimiento
       ...
       FROM usuarios U  
        ...
        LEFT JOIN unidades_medicas UM ON UM.id = M.unidad_medica_id`,
    );
      ...
      response = await client.query(
        `UPDATE medicos 
          SET num_jvpm = $1,
              ...
              unidad_medica_id = $3
          WHERE usuario_id = $4
          RETURNING id AS medicoId, num_jvpm AS numJvpm, especialidad_id AS especialidadId
          , unidad_medica_id AS unidadMedicaId`,
